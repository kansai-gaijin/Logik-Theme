...
use function Logik\Theme\App\config;
...
add_action('after_setup_theme', 'Logik\Theme\App\Setup\add_theme_supports');
...
add_action('after_setup_theme', 'Logik\Theme\App\Setup\load_textdomain');
