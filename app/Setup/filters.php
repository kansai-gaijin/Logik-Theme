...
namespace Logik\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'Logik\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Logik\Theme\App\Setup\show_index_sidebar');
*/
/**
...
add_filter('excerpt_length', 'Logik\Theme\App\Setup\modify_excerpt_length');
*/